...
public class NotifyGatewayStatusApiServiceImpl implements NotifyGatewayStatusApiService {

    public Response notifyGatewayStatusPost(NotifyGatewayStatusRequestDTO notifyGatewayStatusRequestDTO, MessageContext messageContext) {
